...
dependencies {
    testImplementation(project(":rails-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../rails-kotlin-core/src/main/resources/META-INF/proguard/rails-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../rails-kotlin-core/src/main/resources/META-INF/proguard/rails-kotlin-core.pro",
