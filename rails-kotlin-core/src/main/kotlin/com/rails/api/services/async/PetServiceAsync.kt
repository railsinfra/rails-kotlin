...
interface PetServiceAsync {
    ...
    /** @see updateWithFormData */
    suspend fun updateWithFormData(petId: Long, requestOptions: RequestOptions) =
    ...
    interface WithRawResponse {
        ...
        /** @see updateWithFormData */
        @MustBeClosed
        suspend fun updateWithFormData(petId: Long, requestOptions: RequestOptions): HttpResponse =
            updateWithFormData(petId, PetUpdateWithFormDataParams.none(), requestOptions)
