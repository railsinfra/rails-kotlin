...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.railsinfra.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.railsinfra.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.railsinfra.** {
    <init>(...);
