...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.rails.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.rails.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.rails.api.** {
    <init>(...);
